...
Name = "how_to_train_your_dragon"
def scrape_movie_details(Name,Url):
    url_ = requests.get(Url)
    data = BeautifulSoup(url_.text,"html.parser")
    ...
    for i in main_Div:
        ...
        if "\nRating" in b:
            ...
            dict1["movie_name"] = Name
            cast=scrape_movie_cast(Name,Url) 
...
def get_movie_list_details():
    ...
    for i in data1:
        ...
        movie_list.append(y)
        # print(movie_list)
    with open("webscrap13.json","w+") as file5:
